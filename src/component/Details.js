                                ...
                                <div className="col-md-8 col-sm-12">
                                    <div className="card">
                                        <div className="card-body">
                                            ...
                                            <p>
                                                <strong>Age</strong>
                                                <span className="text-success float-end"> {user.age} </span>
                                            </p>
                                        </div>
                                        <div className="card-footer">
                                            <NavLink to={`/update/${user.id}`} className="btn btn-info">Edit</NavLink>
                                            <button onClick={() => deleteUser(user.id)} className="btn btn-danger float-end">Delete</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
